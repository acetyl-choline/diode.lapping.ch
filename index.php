...
<body>
    ...
    <form action="" method="post">
		...
		<label>Wavelength:<br>
			...
			<label>
				<input type="radio" name="wlunit" value="1" checked=<?php echo (floatvar(file_get_contents("wlunit.log")) == 1) ? "checked" : "unchecked";?>>nm</label>
			<label>
				<input type="radio" name="wlunit" value="1000" checked=<?php echo (floatvar(file_get_contents("wlunit.log")) == 1000) ? "checked" : "unchecked";?>>um</label>
		<br>
